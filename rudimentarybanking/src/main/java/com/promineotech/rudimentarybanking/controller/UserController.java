...
//		try {
//			return new ResponseEntity<Object>(authenticationService.register(cred, "USER"), HttpStatus.CREATED);
//		} catch (Exception e) {
...
//		try {
//				return new ResponseEntity<Object>(authenticationService.register(cred, "ADMIN"), HttpStatus.CREATED);
//		} catch (Exception e) {
//			return new ResponseEntity<Object>(e.getMessage(), HttpStatus.BAD_REQUEST);
//		}
//	}
